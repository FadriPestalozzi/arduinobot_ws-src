...
class SimpleActionServer(Node):
    def __init__(self):
        ...
        # self = member of this class
        # Fibonacci = name of message interface, defined in package arduinobot_msgs
        # "fibonacci" = name of action server, used by other nodes to call this action server
    ...
    def goalCallback(self, goal_handle):
        ...
        feedback_msg.partial_sequence = [0, 1] # initialize
        ...
        for i in range(1, goal_handle.request.order):
            ...
            time.sleep(1)
            # placeholder {0} replaced with first argument provided to format()
...
def main():
    ...
    rclpy.spin(simple_action_server) # keep node running
